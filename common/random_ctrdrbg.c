...
static void
randombytes_init_nist(const mlca_random_t *ctx,
...
static size_t
randombytes_nist(const mlca_random_t *ctx, unsigned char *x, size_t xlen) {
...
const mlca_random_t random_nist = {
	.name = "random_system",
	.randombytes_init = randombytes_init_nist,
	.randombytes = randombytes_nist
};
